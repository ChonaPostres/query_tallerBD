...
begin
	...
	where 
		...
		nombre_proveedor = proveedores.nombreproveedor or nombreproveedor is null and
		nombre_producto = productos.nombreproducto or nombreproducto is null and
		cod_rubron1 = rubron1.id_rubro or cod_rubron1 is null and 
		cod_rubron3 = rubron3.id_rubro or cod_rubron3 is null and
		fechainicio <= licitaciones.fechaaceptacion or fechainicio is null and
		licitaciones.fechaaceptacion <= fechafinal or fechafinal is null;
end;
$$
language plpgsql;

select * from Listaritemescompradosendedor(null, null, null, null, null, null, null, date '2019/03/01', date '2019/04/01')
